...
namespace Avanade.TeamBill.ConsoleApp
{
	class Program
	{
		...
		private static void DeleteRecords(CrmServiceClient crmSvc, EntityReference todo) // Operazione di Delete 
		{
			crmSvc.Delete(todo.LogicalName, todo.Id); // Prende il nome e l'ID della vista da cancellare e la cancella.

		}

		private static void UpdateRecords(CrmServiceClient crmSvc, EntityReference todo) // Operazione di Update 
		{
		...
		private static EntityReference RetrieveRecords(CrmServiceClient crmSvc) // Operazione di Lettura
		{
		...
		private static void CreateRecords(CrmServiceClient crmSvc)  // Operazione di Create
		{
